...
from src.soureReconciliationActExtractor import SoureReconciliationActExtractor, XlsColumns
...
class App:
    ...
    def load_table_from_source(self):
        ...
        data = SoureReconciliationActExtractor.standartize_input(raw_data)
