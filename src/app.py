...
from extractors.standartActExtractor import SoureActExtractor
...
class App:
    ...
    def build_button_source_xls_load(self):
        button = tk.Button(
            self.window, text="Load file", command=self.load_table_from_source
        )
        button.pack(pady=10)
